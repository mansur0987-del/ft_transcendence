import {
  require_common,
  require_core
} from "./chunk-B3ZTQUUD.js";
import {
  require_util
} from "./chunk-AVLN2BKX.js";
import "./chunk-RIJT6V5M.js";
import "./chunk-YZWLVYRR.js";
import {
  __commonJS
} from "./chunk-AUZ3RYOM.js";

// ../node_modules/@nestjs/schedule/dist/enums/cron-expression.enum.js
var require_cron_expression_enum = __commonJS({
  "../node_modules/@nestjs/schedule/dist/enums/cron-expression.enum.js"(exports) {
    "use strict";
    ...
    (function(CronExpression2) {
      ...
      CronExpression2["EVERY_WEEK"] = "0 0 * * 0";
      CronExpression2["EVERY_WEEKDAY"] = "0 0 * * 1-5";
      CronExpression2["EVERY_WEEKEND"] = "0 0 * * 6,0";
      ...
      CronExpression2["EVERY_YEAR"] = "0 0 1 0 *";
...
// ../node_modules/@nestjs/schedule/dist/enums/index.js
var require_enums = __commonJS({
  "../node_modules/@nestjs/schedule/dist/enums/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.CronExpression = void 0;
    var cron_expression_enum_1 = require_cron_expression_enum();
    Object.defineProperty(exports, "CronExpression", { enumerable: true, get: function() {
      return cron_expression_enum_1.CronExpression;
    } });
  }
});

// ../node_modules/@nestjs/schedule/dist/enums/scheduler-type.enum.js
var require_scheduler_type_enum = __commonJS({
  "../node_modules/@nestjs/schedule/dist/enums/scheduler-type.enum.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.SchedulerType = void 0;
    var SchedulerType;
    (function(SchedulerType2) {
      SchedulerType2[SchedulerType2["CRON"] = 1] = "CRON";
      SchedulerType2[SchedulerType2["TIMEOUT"] = 2] = "TIMEOUT";
      SchedulerType2[SchedulerType2["INTERVAL"] = 3] = "INTERVAL";
    })(SchedulerType = exports.SchedulerType || (exports.SchedulerType = {}));
  }
});

// ../node_modules/@nestjs/schedule/dist/schedule.constants.js
var require_schedule_constants = __commonJS({
  "../node_modules/@nestjs/schedule/dist/schedule.constants.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_cron_decorator = __commonJS({
  "../node_modules/@nestjs/schedule/dist/decorators/cron.decorator.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Cron = void 0;
    var common_1 = require_common();
    var scheduler_type_enum_1 = require_scheduler_type_enum();
    var schedule_constants_1 = require_schedule_constants();
...
// ../node_modules/@nestjs/schedule/dist/decorators/interval.decorator.js
var require_interval_decorator = __commonJS({
  "../node_modules/@nestjs/schedule/dist/decorators/interval.decorator.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function Interval(nameOrTimeout, timeout) {
      const [name, intervalTimeout] = (0, util_1.isString)(nameOrTimeout) ? [nameOrTimeout, timeout] : [void 0, nameOrTimeout];
...
// ../node_modules/@nestjs/schedule/dist/decorators/timeout.decorator.js
var require_timeout_decorator = __commonJS({
  "../node_modules/@nestjs/schedule/dist/decorators/timeout.decorator.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function Timeout(nameOrTimeout, timeout) {
      const [name, timeoutValue] = (0, util_1.isString)(nameOrTimeout) ? [nameOrTimeout, timeout] : [void 0, nameOrTimeout];
...
// ../node_modules/@nestjs/schedule/dist/decorators/index.js
var require_decorators = __commonJS({
  "../node_modules/@nestjs/schedule/dist/decorators/index.js"(exports) {
    "use strict";
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    __exportStar(require_cron_decorator(), exports);
    __exportStar(require_interval_decorator(), exports);
    __exportStar(require_timeout_decorator(), exports);
  }
});

// ../node_modules/@nestjs/schedule/dist/schedule-metadata.accessor.js
var require_schedule_metadata_accessor = __commonJS({
  "../node_modules/@nestjs/schedule/dist/schedule-metadata.accessor.js"(exports) {
    "use strict";
    ...
    var schedule_constants_1 = require_schedule_constants();
    var SchedulerMetadataAccessor = class SchedulerMetadataAccessor {
...
// ../node_modules/cron/lib/time.js
var require_time = __commonJS({
  "../node_modules/cron/lib/time.js"(exports, module) {
    var CONSTRAINTS = [
      [0, 59],
      [0, 59],
      [0, 23],
    ...
    function CronTime(luxon) {
      ...
      CT.prototype = {
        ...
        _findPreviousDSTJump: function(date) {
          ...
          const afterJumpingPoint = maybeJumpingPoint.plus({ minute: 1 }).set({ seconds: 0, millisecond: 0 });
        ...
        _checkTimeInSkippedRange: function(beforeJumpingPoint, afterJumpingPoint) {
          ...
          if (hourRangeSize === 2 && isHourJump) {
            ...
            return startingHour in this.hour && this._checkTimeInSkippedRangeSingleHour(
              startingMinute,
          ...
          for (let i = 0; i < allRanges.length; i++) {
            if (allRanges[i].match(RE_RANGE)) {
              allRanges[i].replace(RE_RANGE, ($0, lower, upper, step) => {
                ...
                upper = parseInt(upper, 10) || void 0;
...
// ../node_modules/cron/lib/job.js
var require_job = __commonJS({
  "../node_modules/cron/lib/job.js"(exports, module) {
    function CronJob(CronTime, spawn) {
      function fnWrap(cmd) {
        ...
        switch (typeof cmd) {
          case "string":
            args = cmd.split(" ");
            command = args.shift();
            return spawn.bind(void 0, command, args);
          case "object":
            command = cmd && cmd.command;
            if (command) {
              args = cmd.args;
              const options = cmd.options;
              return spawn.bind(void 0, command, args, options);
            }
            break;
        }
        return cmd;
      ...
      const start = function() {
        ...
        function _setTimeout(timeout2) {
          startTime = Date.now();
          self._timeout = setTimeout(callbackWrapper, timeout2);
        ...
        function callbackWrapper() {
          ...
          self.lastExecution = /* @__PURE__ */ new Date();
          if (remaining) {
...
var require_cron = __commonJS({
  "../node_modules/cron/lib/cron.js"(exports, module) {
    (function(root, factory) {
      if (typeof define === "function" && define.amd) {
        define(["luxon"], factory);
      } else if (typeof exports === "object") {
        module.exports = factory(require_luxon(), require_child_process());
      } else {
        root.Cron = factory(root.luxon);
      }
    })(exports, function(luxon, childProcess) {
      const exports2 = {};
      const spawn = childProcess && childProcess.spawn;
      const CronTime = require_time()(luxon);
      const CronJob = require_job()(CronTime, spawn);
      luxon.DateTime.prototype.getWeekDay = function() {
        return this.weekday === 7 ? 0 : this.weekday;
      };
      exports2.job = (cronTime, onTick, onComplete, startNow, timeZone, context, runOnInit, utcOffset, unrefTimeout) => new CronJob(
        cronTime,
        onTick,
        onComplete,
        startNow,
      ...
      exports2.time = (cronTime, timeZone) => new CronTime(cronTime, timeZone);
      exports2.sendAt = (cronTime) => exports2.time(cronTime).sendAt();
      exports2.timeout = (cronTime) => exports2.time(cronTime).getTimeout();
      exports2.CronJob = CronJob;
      exports2.CronTime = CronTime;
      return exports2;
    });
  }
});
...
// ../node_modules/@nestjs/schedule/dist/schedule.messages.js
var require_schedule_messages = __commonJS({
  "../node_modules/@nestjs/schedule/dist/schedule.messages.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.DUPLICATE_SCHEDULER = exports.NO_SCHEDULER_FOUND = void 0;
    var NO_SCHEDULER_FOUND = (schedulerName, name) => name ? `No ${schedulerName} was found with the given name (${name}). Check that you created one with a decorator or with the create API.` : `No ${schedulerName} was found. Check your configuration.`;
    exports.NO_SCHEDULER_FOUND = NO_SCHEDULER_FOUND;
    var DUPLICATE_SCHEDULER = (schedulerName, name) => `${schedulerName} with the given name (${name}) already exists. Ignored.`;
    exports.DUPLICATE_SCHEDULER = DUPLICATE_SCHEDULER;
  }
});

// ../node_modules/@nestjs/schedule/dist/scheduler.registry.js
var require_scheduler_registry = __commonJS({
  "../node_modules/@nestjs/schedule/dist/scheduler.registry.js"(exports) {
    "use strict";
    var __decorate = exports && exports.__decorate || function(decorators, target, key, desc) {
      var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
      if (typeof Reflect === "object" && typeof Reflect.decorate === "function")
    ...
    var common_1 = require_common();
    var schedule_messages_1 = require_schedule_messages();
    var SchedulerRegistry = SchedulerRegistry_1 = class SchedulerRegistry {
      constructor() {
        this.logger = new common_1.Logger(SchedulerRegistry_1.name);
        this.cronJobs = /* @__PURE__ */ new Map();
...
// ../node_modules/@nestjs/schedule/dist/scheduler.orchestrator.js
var require_scheduler_orchestrator = __commonJS({
  "../node_modules/@nestjs/schedule/dist/scheduler.orchestrator.js"(exports) {
    "use strict";
    var __decorate = exports && exports.__decorate || function(decorators, target, key, desc) {
      var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
      if (typeof Reflect === "object" && typeof Reflect.decorate === "function")
    ...
    var common_1 = require_common();
    var cron_1 = require_cron();
    var uuid_1 = require_commonjs_browser();
    var scheduler_registry_1 = require_scheduler_registry();
    var SchedulerOrchestrator = class SchedulerOrchestrator {
      ...
      mountCron() {
        ...
        cronKeys.forEach((key) => {
          ...
          const cronJob = new cron_1.CronJob(options.cronTime, target, void 0, false, options.timeZone, void 0, false, options.utcOffset, options.unrefTimeout);
          if (options.disabled) {
            cronJob.stop();
          } else {
            cronJob.start();
...
// ../node_modules/@nestjs/schedule/dist/schedule.explorer.js
var require_schedule_explorer = __commonJS({
  "../node_modules/@nestjs/schedule/dist/schedule.explorer.js"(exports) {
    "use strict";
    var __decorate = exports && exports.__decorate || function(decorators, target, key, desc) {
      var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
      if (typeof Reflect === "object" && typeof Reflect.decorate === "function")
    ...
    var core_1 = require_core();
    var scheduler_type_enum_1 = require_scheduler_type_enum();
    var schedule_metadata_accessor_1 = require_schedule_metadata_accessor();
    var scheduler_orchestrator_1 = require_scheduler_orchestrator();
    var ScheduleExplorer = class ScheduleExplorer {
      ...
      explore() {
        ...
        instanceWrappers.forEach((wrapper) => {
          ...
          this.metadataScanner.scanFromPrototype(instance, Object.getPrototypeOf(instance), (key) => wrapper.isDependencyTreeStatic() ? this.lookupSchedulers(instance, key) : this.warnForNonStaticProviders(wrapper, instance, key));
        });
      }
...
// ../node_modules/@nestjs/schedule/dist/schedule.module.js
var require_schedule_module = __commonJS({
  "../node_modules/@nestjs/schedule/dist/schedule.module.js"(exports) {
    "use strict";
    var __decorate = exports && exports.__decorate || function(decorators, target, key, desc) {
      var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
      if (typeof Reflect === "object" && typeof Reflect.decorate === "function")
    ...
    var core_1 = require_core();
    var schedule_metadata_accessor_1 = require_schedule_metadata_accessor();
    var schedule_explorer_1 = require_schedule_explorer();
    var scheduler_orchestrator_1 = require_scheduler_orchestrator();
    var scheduler_registry_1 = require_scheduler_registry();
    var ScheduleModule = ScheduleModule_1 = class ScheduleModule {
      static forRoot() {
        return {
          global: true,
...
// ../node_modules/@nestjs/schedule/dist/index.js
var require_dist = __commonJS({
  "../node_modules/@nestjs/schedule/dist/index.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
    ...
    __exportStar(require_schedule_module(), exports);
    __exportStar(require_scheduler_registry(), exports);
  }
});

// ../node_modules/@nestjs/schedule/index.js
var require_schedule = __commonJS({
  "../node_modules/@nestjs/schedule/index.js"(exports) {
    function __export(m) {
      for (var p in m)
...
//# sourceMappingURL=@nestjs_schedule.js.map
